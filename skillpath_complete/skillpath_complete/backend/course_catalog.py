...
COURSE_CATALOG = [
    ...
    {
        "id": "ML04",
        "title": "LLM Engineering and Prompt Design",
        "skills": ["llm", "prompt engineering", "langchain", "openai", "claude", "ai", "generative ai", "chatgpt"],
        "duration": "3 days",
        "level": "intermediate",
        "domain": "technical",
        "description": "Building production applications on top of large language models using prompt engineering and chaining frameworks",
        "prerequisites": ["PY02"]
    },
    {
        "id": "DS01",
        "title": "Data Science Foundations",
        "skills": ["data science", "statistics", "hypothesis testing", "r", "scipy", "statistical analysis", "regression"],
        "duration": "4 days",
        "level": "intermediate",
        "domain": "technical",
        "description": "Statistical thinking, probability distributions, A/B testing, linear and logistic regression",
        "prerequisites": ["DA01"]
    },
    {
        "id": "DS02",
        "title": "Feature Engineering and Model Deployment",
        "skills": ["feature engineering", "mlops", "model deployment", "pipeline", "model monitoring", "fastapi"],
        "duration": "3 days",
        "level": "advanced",
        "domain": "technical",
        "description": "Building ML pipelines, feature stores, model serving APIs, and production monitoring",
        "prerequisites": ["ML01", "API01"]
    },
    {
        "id": "HR01",
        "title": "HR and People Management Fundamentals",
        "skills": ["hr", "recruitment", "performance review", "compensation", "culture", "onboarding", "offboarding"],
        "duration": "2 days",
        "level": "beginner",
        "domain": "business",
        "description": "Hiring processes, performance cycles, employee relations, and HR compliance basics",
        "prerequisites": []
    },
    {
        "id": "MKT01",
        "title": "Digital Marketing and Growth Fundamentals",
        "skills": ["marketing", "seo", "sem", "google analytics", "content marketing", "social media", "growth hacking"],
        "duration": "2 days",
        "level": "beginner",
        "domain": "business",
        "description": "Digital channels, SEO basics, paid advertising, analytics dashboards, and campaign fundamentals",
        "prerequisites": []
    },
    {
        "id": "MKT02",
        "title": "Data-Driven Marketing and Attribution",
        "skills": ["marketing analytics", "attribution", "funnel analysis", "cohort analysis", "a/b testing", "conversion rate"],
        "duration": "2 days",
        "level": "intermediate",
        "domain": "business",
        "description": "Marketing measurement, multi-touch attribution, funnel optimisation, and experiment design",
        "prerequisites": ["MKT01", "DA01"]
    },
    {
        "id": "NET01",
        "title": "Networking and TCP/IP Fundamentals",
        "skills": ["networking", "tcp/ip", "dns", "http", "https", "load balancing", "vpn", "firewall", "subnetting"],
        "duration": "2 days",
        "level": "beginner",
        "domain": "technical",
        "description": "OSI model, IP addressing, DNS resolution, HTTP protocol, and network security basics",
        "prerequisites": []
    },
    {
        "id": "DB01",
        "title": "NoSQL Databases and MongoDB",
        "skills": ["nosql", "mongodb", "document database", "redis", "elasticsearch", "dynamodb", "cassandra"],
        "duration": "2 days",
        "level": "intermediate",
        "domain": "technical",
        "description": "Document, key-value, and search database patterns, schema design, indexing, and query optimisation",
        "prerequisites": ["SQL01"]
    },
    {
        "id": "SOFT01",
        "title": "Presentation and Executive Communication",
        "skills": ["presentation", "executive communication", "storytelling", "powerpoint", "public speaking", "boardroom", "slide design"],
        "duration": "1 day",
        "level": "intermediate",
        "domain": "business",
        "description": "Structuring persuasive narratives, data storytelling, slide design principles, and executive presence",
        "prerequisites": ["COM01"]
    },
    {
        "id": "SOFT02",
        "title": "Negotiation and Stakeholder Influence",
        "skills": ["negotiation", "influence", "stakeholder management", "persuasion", "conflict resolution", "consensus building"],
        "duration": "1 day",
        "level": "intermediate",
        "domain": "business",
        "description": "Principled negotiation frameworks, influence without authority, and managing competing stakeholder interests",
        "prerequisites": ["COM01"]
    },
    {
        "id": "SOFT03",
        "title": "Critical Thinking and Problem Solving",
        "skills": ["critical thinking", "problem solving", "root cause analysis", "first principles", "decision making", "analytical thinking"],
        "duration": "1 day",
        "level": "beginner",
        "domain": "business",
        "description": "Structured problem decomposition, logical reasoning, cognitive bias awareness, and decision frameworks",
        "prerequisites": []
    },
    {
        "id": "LEGAL01",
        "title": "Corporate Legal and Contract Basics",
        "skills": ["legal", "contracts", "nda", "intellectual property", "gdpr", "data protection", "compliance", "terms of service"],
        "duration": "1 day",
        "level": "beginner",
        "domain": "business",
        "description": "Reading contracts, IP ownership, data privacy law, and basic corporate legal obligations",
        "prerequisites": []
    },
    {
        "id": "REACT01",
        "title": "Advanced React Patterns and Performance",
        "skills": ["react", "react advanced", "performance optimization", "react query", "zustand", "testing library", "nextjs"],
        "duration": "3 days",
        "level": "advanced",
        "domain": "technical",
        "description": "Custom hooks, compound components, render optimisation, server components, and production testing strategies",
        "prerequisites": ["JS02"]
    },
    {
        "id": "TS01",
        "title": "TypeScript for Production Applications",
        "skills": ["typescript", "type safety", "generics", "interfaces", "type guards", "decorators", "strict mode"],
        "duration": "2 days",
        "level": "intermediate",
        "domain": "technical",
        "description": "Advanced TypeScript patterns, strict typing, utility types, and integrating TypeScript in large codebases",
        "prerequisites": ["JS01"]
    },
    {
        "id": "ANALYTICS01",
        "title": "Business Analytics and KPI Design",
        "skills": ["business analytics", "kpi", "metrics", "okr", "dashboard design", "reporting", "looker", "metabase"],
        "duration": "2 days",
        "level": "intermediate",
        "domain": "business",
        "description": "Designing meaningful KPIs, building BI dashboards, OKR frameworks, and data-driven decision making",
        "prerequisites": ["XL01"]
    },
    {
        "id": "CLOUD03",
        "title": "Cloud Cost Optimisation and FinOps",
        "skills": ["cloud cost", "finops", "cost optimisation", "rightsizing", "reserved instances", "cloud billing", "budget alerts"],
        "duration": "1 day",
        "level": "intermediate",
        "domain": "technical",
        "description": "Cloud spending analysis, rightsizing compute resources, savings plans, and building cost accountability culture",
        "prerequisites": ["CLD01"]
    },
    {
        "id": "TEST01",
        "title": "Software Testing and QA Fundamentals",
        "skills": ["testing", "unit testing", "integration testing", "pytest", "jest", "tdd", "bdd", "test automation", "qa"],
        "duration": "2 days",
        "level": "intermediate",
        "domain": "technical",
        "description": "Test pyramid, unit and integration testing, TDD workflow, mocking, and CI-integrated test automation",
        "prerequisites": ["PY01"]
    },
    {
        "id": "DESIGN01",
        "title": "Systems Design and Scalability",
        "skills": ["systems design", "scalability", "distributed systems", "caching", "message queues", "load balancer", "sharding"],
        "duration": "3 days",
        "level": "advanced",
        "domain": "technical",
        "description": "Designing high-availability systems, CAP theorem, caching strategies, message brokers, and database scaling",
        "prerequisites": ["API01", "DB01"]
    },
    {
        "id": "REMOTE01",
        "title": "Remote Work and Async Collaboration",
        "skills": ["remote work", "async communication", "notion", "confluence", "slack", "documentation", "distributed team", "time zones"],
        "duration": "1 day",
        "level": "beginner",
        "domain": "business",
        "description": "Writing for async audiences, documentation culture, virtual meeting facilitation, and remote team trust building",
        "prerequisites": []
    },
    {
        "id": "ETHICS01",
        "title": "AI Ethics and Responsible Technology",
        "skills": ["ai ethics", "responsible ai", "bias", "fairness", "explainability", "privacy", "algorithmic accountability"],
        "duration": "1 day",
        "level": "beginner",
        "domain": "technical",
        "description": "Bias in AI systems, fairness metrics, explainable AI, privacy by design, and ethical decision frameworks for tech",
        "prerequisites": []
    },
]
